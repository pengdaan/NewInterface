...
from TestRun import TestAllRunner
...
Test_Report=('../TestReport/'+now+'report.xlsx')
#Test_Report=parentdir+'/TestReport/'+now+'report.xlsx'
workbook = xlsxwriter.Workbook(Test_Report)#生成的报告的路径
...
def init(worksheet):
    ...
    worksheet.merge_range('A3:A6', '点评接口', get_format_center(workbook))
    ...
    data = {"test_name": "小树熊电商平台", "test_version": "v1.0.0", "test_pl": "Python3", "test_net": "NET"}
...
def test_detail(worksheet):
    ...
    for item in data["info"]:
        ...
        _write_center(worksheet, "C"+str(temp), item["method"], workbook)
